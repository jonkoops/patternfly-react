import { ButtonHTMLAttributes, ReactNode, FunctionComponent, useState } from 'react';
...
export interface SortColumnProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  children?: ReactNode;
  className?: string;
  isSortedBy?: boolean;
  onSort?: Function;
...
export const SortColumn: FunctionComponent<SortColumnProps> = ({
  children = null,
  className = '',
  isSortedBy = false,
  onSort = null,
