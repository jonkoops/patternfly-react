import { HTMLProps, FunctionComponent, useState, useRef, useEffect, Fragment } from 'react';
...
interface TruncateProps extends HTMLProps<HTMLSpanElement> {
...
export const Truncate: FunctionComponent<TruncateProps> = ({
  className,
  position = 'end',
  tooltipPosition = 'top',
  trailingNumChars = 7,
