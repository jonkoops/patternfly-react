...
export interface LoginFormProps extends Omit<HTMLProps<HTMLFormElement>, 'ref'> {
  ...
  onChangeUsername?: (event: FormEvent<HTMLInputElement>, value: string) => void;
  ...
  onChangePassword?: (event: FormEvent<HTMLInputElement>, value: string) => void;
  ...
  onChangeRememberMe?: (event: FormEvent<HTMLInputElement>, checked: boolean) => void;
}
