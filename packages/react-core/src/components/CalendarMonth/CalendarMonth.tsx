...
export interface CalendarProps extends CalendarFormat, Omit<HTMLProps<HTMLDivElement>, 'onChange'> {
  ...
  onMonthChange?: (event?: ReactMouseEvent | ChangeEvent | FormEvent<HTMLInputElement>, newDate?: Date) => void;
...
export const CalendarMonth = ({
  ...
  const handleYearInputChange = (event: FormEvent<HTMLInputElement>, yearStr: string) => {
